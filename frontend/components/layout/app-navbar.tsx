        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          {isAuthenticated && user ? (
            <div className="relative" ref={ref}>
              ...
              {open && (
                <div className="absolute right-0 top-full mt-2 w-72 max-w-[calc(100vw-32px)] bg-white border border-[#dddddd] rounded-[16px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] py-2 z-50">
                  {/* Role badge */}
