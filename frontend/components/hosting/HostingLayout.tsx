  ...
  return (
    <div className="flex flex-col bg-white min-h-screen">
      ...
      <div className="flex flex-1 min-h-[calc(100vh-128px)] md:min-h-[calc(100vh-80px)]">
        ...
        <aside ref={sidebarRef} className="hidden md:flex w-[223px] shrink-0 flex-col items-start bg-white border-r border-[#DDDDDD]">
        ...
        {/* Main content area */}
        <div className="flex-1 flex flex-col items-start bg-[#F6F8FB] p-4 md:p-8">
