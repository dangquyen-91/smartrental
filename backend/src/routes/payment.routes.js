...
// ─── Subscription ─────────────────────────────────────────────────────────────
router.post('/subscription/:planKey', protect, authorizeRoles('landlord'), createSubscriptionPaymentLink);
router.get('/subscription/status',    protect, authorizeRoles('landlord'), getSubscriptionPaymentStatus);
